...
_SECTOR_RULES = [
    ("Technology", ("digital transformation", "software", "ict", "information technology",
                     ...
                     "payments modernisation", "payments modernization", "instant payments",
                     "digital channels", "cloud migration", "cloud readiness",
                     "penetration testing", "business continuity management",
                     "cyber incident response", "security architecture",
                     "post implementation review", "embedded finance", "open banking",
                     "fintech")),
